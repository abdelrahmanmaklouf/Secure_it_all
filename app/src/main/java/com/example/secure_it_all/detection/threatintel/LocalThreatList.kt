...
object LocalThreatList {
    ...
    private val entries = mapOf(
        "suspicious-domain.test" to ThreatListEntry(
            "suspicious-domain.test",
            "MALWARE",
            90
        ),
        "secure-bank-login.example" to ThreatListEntry(
            "secure-bank-login.example",
            "PHISHING",
            85
        ),
        "185.220.101.5" to ThreatListEntry(
            "185.220.101.5",
            "MALWARE",
            75
        )
    ...
    private val threats = mapOf(
        "test-phishing-example.com" to ThreatEntry(
            "PHISHING",
            80
        )
    )
